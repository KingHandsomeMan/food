    ...
    <body>
        ...
        <div class="x-body">
          <!--<form class="layui-form x-center" action="" style="width:500px">
            ...
            <?php
                require "conn.php";
                $sql = "select message.* ,trainer.tname from message,trainer where message.tid = trainer.tid ";
                ...
                while($row = mysqli_fetch_assoc($result)){
                    ...
                    <div class="contentbox">
                        <div class="content" >
                            <div class="img">
                                <img src="images/car.jpg" width="900px" height="300px"/>
                            </div>
                            <div class="text">
                                <p>标  题：<?=$row['title']?></p>
                                <h>发布者：<?=$row['tname']?></h>
                                <p>
                                    <button> <a href="message_detail.php?id=<?=$row['mid']?>">查看详情</a></button>
                                </p>
                            </div>
                        </div>
                    </div>
